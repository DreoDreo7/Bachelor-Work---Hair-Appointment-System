...
const RegisterPage = () => {
  ...
  // const [isBarberChecked, setIsBarberChecked] = useState(false);
  ...
  const handleSubmit = async (event) => {
    ...
    // if (isBarberChecked) {
    //   if (barberCode !== "StudioTheOne") {
    //     setBarberCodeError("Barber code is wrong, please try again");
    //     return;
    //   }

    //   registrationMessage += " barber";
    // }
  ...
  // const handleBarberCheckboxChange = () => {
  //   setIsBarberChecked(!isBarberChecked);
  //   setBarberCode("");
  //   setBarberCodeError("");
  // };
...
{/* 
          <div className="form-group">
            <label>
              ...
              <input
                type="checkbox"
                checked={isBarberChecked}
                onChange={handleBarberCheckboxChange}
          ...
          {isBarberChecked && (
            <div className="form-group">
              ...
              <small style={{ color: barberCodeError ? "red" : "gray" }}>
                {focusedField === "barberCode" ? barberCodeError : ""}
              </small>
            </div>
          )} */}
